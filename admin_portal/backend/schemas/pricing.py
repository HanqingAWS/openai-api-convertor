...
class PricingCreate(BaseModel):
    ...
    cache_write_5m_price: Optional[float] = Field(None, description="Cache write 5m TTL price per 1M tokens")
    cache_write_1h_price: Optional[float] = Field(None, description="Cache write 1h TTL price per 1M tokens")
